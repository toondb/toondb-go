...
func findBinary(name string) (string, error) {
	if envPath := os.Getenv("SOCHDB_GRPC_SERVER_PATH"); envPath != "" {
...
func main() {
	...
	if err != nil {
		...
		fmt.Fprintln(os.Stderr, "Please ensure SochDB is installed or set SOCHDB_GRPC_SERVER_PATH.")
		os.Exit(1)
	}
